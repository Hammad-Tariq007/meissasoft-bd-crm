...
export const IssueDetailRoot = observer(function IssueDetailRoot(props: TIssueDetailRoot) {
  ...
  // Editing is ownership-based: the assigned BD and project admins can edit
  // this lead's properties; everyone else is read-only (+ comments).
  const { isEditable } = useWorkItemPermissions(workspaceSlug, projectId, issue?.assignee_ids);
