...
export const IssueDefaultProperties = observer(function IssueDefaultProperties(props: TIssueDefaultPropertiesProps) {
  ...
  // BD-leads: the create/edit modal intentionally exposes only State + Priority
  // (alongside title & description). The remaining native fields are hidden — not
  // removed — so they can be restored by flipping this flag back to true.
  const SHOW_NATIVE_SECONDARY_FIELDS = false;
